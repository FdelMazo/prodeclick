import { Card, CardBody, Flex, IconButton, Stat, StatHelpText, StatLabel, StatNumber } from '@chakra-ui/react';
export default function Default({ startContent, bottomContent, topContent, name, description, value, ...rest }) {
	...
	return (
		<Card>
			<CardBody p={2} w='100%' h='100%' justifyContent="space-between" {...rest}>
			{topContent}
			<Flex
				h='100%'
				align="center"
